...
def create_department(
    ...
    current_user: User = Depends(require(Permission.MANAGE_DEPARTMENTS)),
    ...
    new_dept = Department(name=dept.name, description=dept.description, manager_id=dept.manager_id)
    db.add(new_dept)
    db.commit()
    db.refresh(new_dept)
    return new_dept
